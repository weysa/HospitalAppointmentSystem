                    ...
                    <section>
                        <header>
                            ...
                            <p class="mt-1 text-sm text-gray-600">
                                {{ __('Silakan isi form di bawah ini untuk menambahkan Janji pemeriksaan dokter sesuai dengan hari dan waktu yang tersedia.') }}
                            </p>
                        </header>
                        @if ($errors->any())
                        ...
                        {{-- <form class="mt-6" id="formJanji" action="{{route('dokter.Janji-periksa.store')}}" method="POST"> --}}
                            {{-- @csrf --}}
